...
const {createOrder , receiveWebhooks,getDataPayment} = require("../controllers/paymentController")

const paymentRoute = Router();


paymentRoute.post("/createOrder/:idKey", createOrder);
paymentRoute.get("/success/:idkey", getDataPayment, (req,res) => res.send("success"));
